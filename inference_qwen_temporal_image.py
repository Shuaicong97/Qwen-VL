...
def load_video_frames(video_path, num_frames=-1):
    # 1. 读取并排序所有 jpg
    frame_paths = sorted(
...
def main():
    ...
    if args.dataset.lower() == "ovis":
        ...
        OUTPUT_DIR = "/nfs/data3/shuaicong/SVAG-Bench/Qwen-VL/outputs/ovis_temporal_images"
    ...
    for video_idx, (video_name, query_list) in enumerate(
        ...
        video_image_inputs = load_video_frames(
            video_path,
            args.num_frames
        )
