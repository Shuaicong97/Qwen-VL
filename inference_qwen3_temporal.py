...
def main():
    ...
    if args.dataset.lower() == "ovis":
        ...
        OUTPUT_DIR = "/nfs/data3/shuaicong/SVAG-Bench/Qwen-VL/outputs/ovis_temporal_qwen3"
        ...
        OUTPUT_DIR = "/nfs/data3/shuaicong/SVAG-Bench/Qwen-VL/outputs/mot17_temporal_qwen3"
        ...
        OUTPUT_DIR = "/nfs/data3/shuaicong/SVAG-Bench/Qwen-VL/outputs/mot20_temporal_qwen3"
    else:
