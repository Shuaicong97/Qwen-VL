...
python3 run_mot_challenge.py \
--METRICS HOTA \
--SEQMAP_FILE /home/stud/shuaicong/forkProjects/RMOT/datasets/data_path/seqmap_mot17.txt \
--SKIP_SPLIT_FOL True \
--GT_FOLDER /nfs/data3/shuaicong/TempRMOT/refer-mot17/MOT17/valid \
--TRACKERS_FOLDER /nfs/data3/shuaicong/SVAG-Bench/Qwen-VL/spatial_preds/mot17 \
--GT_LOC_FORMAT {gt_folder}{video_id}/{expression_id}/gt.txt \
--TRACKERS_TO_EVAL /nfs/data3/shuaicong/SVAG-Bench/Qwen-VL/spatial_preds/mot17 \
--USE_PARALLEL True \
--NUM_PARALLEL_CORES 2 \
--SKIP_SPLIT_FOL True \
--PLOT_CURVES False
